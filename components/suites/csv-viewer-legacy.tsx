...
export function CsvViewerLegacySuite() {
  ...
  return (
    <ToolShell
      ...
      category="データ"
      title="CSV Viewer Legacy"
      description="正式版昇格前の安定版です。障害時のrollback確認用で、通常のツール一覧には出ません。"
      functionCount={1}
      tabs={[
    ...
    >
      <div className="csv-viewer-flow">
        <section className="csv-beta-banner" aria-label="Legacy注意">
          <strong>LEGACY</strong>
          <p>これはrollback用の旧安定版です。通常は正式版を使ってください。</p>
